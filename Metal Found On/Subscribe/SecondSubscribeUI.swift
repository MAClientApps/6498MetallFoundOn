...
extension SecondSubscribeViewController {
    ...
    func setup() {
        ...
        firstSelectedTopLabel!.font = UIFont.systemFont(ofSize: 16, weight: .medium)
        secondSelectedTopLabel!.font = UIFont.systemFont(ofSize: 16, weight: .medium)
        thirdSelectedTopLabel!.font = UIFont.systemFont(ofSize: 16, weight: .medium)
        
        firstTopLabel!.font = UIFont.systemFont(ofSize: 14, weight: .medium)
        secondTopLabel!.font = UIFont.systemFont(ofSize: 14, weight: .medium)
        thirdTopLabel!.font = UIFont.systemFont(ofSize: 14, weight: .medium)
        ...
        //restoreButton.addTarget(self, action: #selector(restoreTarget), for: .touchUpInside)
        ...
        let constraint = [
            ...
            dismissView.centerYAnchor.constraint(equalTo: restoreLabel.centerYAnchor),
